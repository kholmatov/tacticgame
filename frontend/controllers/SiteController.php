...
class SiteController extends Controller
{
    ...
    {
        //echo \kholmatov\lacaixa\AutoloadExample::ShowForm();
        $modelSections = Sections::find()
            ->where('active >= :active',['active'=>1])->all();
        //print_r($modelSections);
        ...
        if(Yii::$app->language=='es-ES' || Yii::$app->language=='es'):
            ...
            $n =count($modelPosition);
            for($i=0;$i < $n;$i++){
                $modelPosition[$i]['title'] = $modelPosition[$i]['title_es'];
                $modelPosition[$i]['address'] = $modelPosition[$i]['address_es'];
            }
