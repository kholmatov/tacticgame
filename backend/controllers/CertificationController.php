...
class CertificationController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->validate()) {
                $model->file->saveAs(Yii::$app->params['dirUploadPath'].'/certification/'. $model->file->baseName . '.' . $model->file->extension);
            }

            $model->photo = '/certification/' . $model->file->baseName . '.' . $model->file->extension;
            $model->save();
